...
import { isToday, format, parseISO, parse, isAfter } from 'date-fns';
          ...
          <Section>
            ...
            {morningAppointment.map(appointment => (
              <Appointment key={appointment.id}>
                ...
                <div>
                  <img src={appointment.user.avatar_url ? appointment.user.avatar_url : 'https://avatars1.githubusercontent.com/u/65176656?s=460&v=4'} alt={appointment.user.name}/>
